...
local function setupNvimTreePlugin()
...
local function errorHandlerForNvimTree(error)
  notify('nvim-tree plugin could not be loaded!', WARN)
  notify(error, ERROR)
end

tryCatch(setupNvimTreePlugin, errorHandlerForNvimTree)
